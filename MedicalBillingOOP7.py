...
class Optometrist(Specialist):
    def __init__(self, medical_aid_balance, contact_lenses=0, spectacles=0):
        Specialist.__init__(self, medical_aid_balance)
        ...
        def medical_aid_claim(self, consultation, prescription, medical_tests, radiology_referral, blood_tests, medical_aid_balance, contact_lenses):
            if self.medical_aid_balance >= eye_wear:
                Specialist.medical_aid_claim(self, consultation, prescription, medical_tests, radiology_referral, blood_tests, medical_aid_balance - contact_lenses)
            else:
                return False
...
patient1 = Optometrist(7600, 40, 30)
patient1.medical_aid_claim(0, 0, 0, 7600, 40)

#Debug for method inheritance
